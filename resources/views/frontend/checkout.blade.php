...
@section('content')
    ...
    <table id="cart" class="table table-hover table-condensed">
            ...
            @foreach(session('cart') as $id => $details)
                ...
                <tr>
                    ...
                    <td data-th="Quantity">{{$details['quantity']}}
                        <input type="number" class="form-control text-center" value="1">Rp. {{$details['price']*$details['quantity']}}
                    </td>
        ...
        <tr>
            ...
            <td class ="hidden-xs"><a href="{{route('submitcheckout')}}" class="btn btn-danger">Finish<i class="fa fa-angel-right"></i></a></td>
